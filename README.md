...
Port 4 | Zebra-tech Hydro-Wiper unit
...
5 | CR1000 Port C6 (Com3-RX) | RS232 TX
6 | CR1000 Port C5 (Com3-TX) | RS232 RX
7 | CR1000 SE3 | Sensor analog signal +
8 | N/C | N/A

#### Port 4
Pin Number |Zebra-Tech Data-logger controlled Hydro-Wiper Module Pin
------------ | -------------
1 | 1
2 | 2
3 | 3
...
3 | Power Ground | Sensor Communication Ground
4 | N/C | N/A
5 | SC105 RX (SDC8)| Sensor RS232 TX
6 | SC105 TX (SDC8)| Sensor RS232 RX
7 | N/C | N/A
8 | N/C | N/A
...
- 1x Zebra-Tech Data-logger controlled Hydro-Wiper control module

# Notes

- Logger must be running OS>28
- Logger should have a 2GB CF card
- This code supports EXO DCP-SOA v1. It can support v2, but main program code (se108main.cr1) will need to be updated to handle increased wake up delay time. See DCP-SOA user manual for details.
